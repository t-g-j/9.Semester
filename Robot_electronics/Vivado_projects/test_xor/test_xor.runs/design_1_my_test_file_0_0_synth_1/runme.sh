...
HD_PWD='/home/tj/Documents/Xilinx/Projects/test_xor/test_xor.runs/design_1_my_test_file_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_test_file_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_test_file_0_0.tcl
