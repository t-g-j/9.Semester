...
HD_PWD='/home/tj/Documents/Xilinx/Projects/test_project_1/test_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delete_blk_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delete_blk_design_1_wrapper.tcl
