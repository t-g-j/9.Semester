...
HD_PWD='/home/tj/Documents/Xilinx/Projects/unity_exercise/unity_exercise.runs/unity_excercise_design_1_axi_uartlite_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unity_excercise_design_1_axi_uartlite_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unity_excercise_design_1_axi_uartlite_0_1.tcl
