...
HD_PWD='/home/tj/Documents/Xilinx/Projects/unity_exercise/unity_exercise.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unity_excercise_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source unity_excercise_design_1_wrapper.tcl -notrace
