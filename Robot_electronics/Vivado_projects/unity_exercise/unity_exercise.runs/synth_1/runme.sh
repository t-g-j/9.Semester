...
HD_PWD='/home/tj/Documents/Xilinx/Projects/unity_exercise/unity_exercise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unity_excercise_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unity_excercise_design_1_wrapper.tcl
