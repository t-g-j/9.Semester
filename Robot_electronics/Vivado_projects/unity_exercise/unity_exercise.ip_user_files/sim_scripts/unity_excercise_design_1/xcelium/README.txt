...
#
# Generated by export_simulation on Wed Oct 24 11:24:41 CEST 2018
#
################################################################################
...
'-reset_run' switch to the './unity_excercise_design_1.sh' script.

./unity_excercise_design_1.sh -reset_run
...
./unity_excercise_design_1.sh -noclean_files

For more information on the script, please type './unity_excercise_design_1.sh -help'.
